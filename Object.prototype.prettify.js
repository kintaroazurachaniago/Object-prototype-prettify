...
const objectData = {
	pertama : {
		text : 'ketuhanan yang maha esa', deskripsi : 'harus punya satu tuhan'
	},
	kedua : {
		text : 'kemanusiaan yang adil dan ber-adab', deskripsi : 'harus adil dan tidak kejam'
	},
	ketiga : {
		text : 'persatuan indonesia', deskripsi : 'harus bersatu dalam kebaikan'
	},
	keempat : {
		text : 'kerakyatan yang dipimpin oleh hikmat kebijaksaan dalam permusyawaratan perwakilan', deskripsi : 'mematuhi pemimpin yang bijaksana dan mewakili rakyat'
	},
	kelima : {
		text : 'keadilan sosial bagi seluruh rakyat indonesia', deskripsi : 'harus adil untuk seluruh warga negara indonesia'
	}
}

/* Array data */
const arrayData = [
	{ sila : 'pertama', text : 'ketuhanan yang maha esa', deskripsi : 'harus punya satu tuhan' },
	{ sila : 'kedua', text : 'kemanusiaan yang adil dan ber-adab', deskripsi : 'harus adil dan tidak kejam' },
	{ sila : 'ketiga', text : 'persatuan indonesia', deskripsi : 'harus bersatu dalam kebaikan' },
	{ sila : 'keempat', text : 'kerakyatan yang dipimpin oleh hikmat kebijaksaan dalam permusyawaratan perwakilan', deskripsi : 'mematuhi pemimpin yang bijaksana dan mewakili rakyat' },
	{ sila : 'kelima', text : 'keadilan sosial bagi seluruh rakyat indonesia', deskripsi : 'harus adil untuk seluruh warga negara indonesia' }
]


/* Object in array */
const users = [
	{ id : 1231, name : 'kintaro azura chaniago', username : function() {}, password : function() {}, objectData },
	{ id : 234645634, name : 'anna mae d custan', username : function() {}, password : function() {}, objectData },
	{ id : 657234645634, name : 'uzumaki naruto', username : function() {}, password : function() {}, objectData }
]

/* Object key value */
const kintaro = {
	id : 1231,
	name : 'kintaro azura chaniago',
	username : function() {},
	password : function() {},
	hobby : ['coding', 'reading', 'fighting', { another : 'spying', other : 'playing' }]
}

console.log(Object.prettify(users))
console.log(Object.prettify(kintaro))